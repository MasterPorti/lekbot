...
export default function Battery({ position }) {
  ...
  return (
    <>
      ...
      >
        <Image
          src="/componets/battery.png"
          width={80}
          height={80}
          alt="Battery Component"
          className="object-cover rounded-2xl"
        />
        <div
          onClick={handlePinClick}
          className="w-3.5 h-3.5 top-[5px] left-[28px] absolute hover:bg-red-500 hover:border-4 border-black cursor-pointer z-10"
        ></div>
        <div
          onClick={handlePinClick}
          className="w-3.5 h-3.5 top-[5px] left-[55px] absolute hover:bg-blue-500 hover:border-4 border-black cursor-pointer z-10"
        ></div>
      </div>
